...
export const Signup: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      {/* Orb Backgrounds */}
      <div style={{ position: 'absolute', top: '10%', right: '15%', width: '300px', height: '300px', background: '#920004', filter: 'blur(120px)', opacity: 0.3, borderRadius: '50%', zIndex: -1 }}></div>
      <div style={{ position: 'absolute', bottom: '15%', left: '10%', width: '400px', height: '400px', background: '#F37100', filter: 'blur(150px)', opacity: 0.2, borderRadius: '50%', zIndex: -1 }}></div>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 600, color: 'white', marginBottom: '8px' }}>Create your account</h2>
        <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.42)', marginBottom: '24px' }}>Sign up for SnapLink</p>

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            <label style={{ display: 'block', fontSize: '12px', color: 'rgba(255,255,255,0.6)', marginBottom: '8px', fontWeight: 500 }}>Name (Optional)</label>
            <input
              type="text"
              value={name}
